...
if (!isset($submit)) {
	// Main body
	if(!empty($prenom_form)){
		$prenom_formEsc = esc($prenom_form);
	}
	if(!empty($nom_form)){
		$nom_formEsc = esc($nom_form);
	}
	if(!empty($uname)){
		$unameEsc = esc($uname);
	}
	...
	<td colspan='2'><input type='text' name='prenom_form' value='$prenom_formEsc' class='FormData_InputText' />&nbsp;&nbsp;<small>(*)</small></td>
	</tr>
	<tr>
	<th class='left'>$langSurname</th>
	<td colspan='2'><input type='text' name='nom_form' value='$nom_formEsc' class='FormData_InputText' />&nbsp;&nbsp;<small>(*)</small></td>
	</tr>
	<tr>
	<th class='left'>$langUsername</th>
	<td colspan='2'><input type='text' name='uname' value='$unameEsc' size='20' maxlength='20' class='FormData_InputText' />&nbsp;&nbsp;<small>(*) $langUserNotice</small></td>
	</tr>
	<tr>
	...
	<td valign='top'><input type='text' name='email' value='$emailEsc' class='FormData_InputText' /></td>
	<td><small>$langEmailNotice</small></td>
	</tr>
	<tr>
	<th class='left'>$langAm</th>
	<td colspan='2' valign='top'><input type='text' name='am' value='$amEsc' class='FormData_InputText' /></td>
	</tr>
	<tr>
	...
	$auth_method_settings = get_auth_settings(escapeSimple($auth));
	...
	$tool_content .= "<table width='99%'><tbody><tr>" .
		...
		$tool_content .= "<p><a href='".esc($_SERVER['PHP_SELF'])."?prenom_form=".esc($_POST['prenom_form'])."&nom_form=".esc($_POST['nom_form'])."&uname=".esc($_POST['uname'])."&email=".esc($_POST['email'])."&am=".esc($_POST['am'])."'>$langAgain</a></p>" .
